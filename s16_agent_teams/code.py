#!/usr/bin/env python3
"""
s16: Agent Teams — MessageBus + spawn_teammate_thread + inbox injection.

Run:  python s16_agent_teams/code.py
...
# ── Cron Scheduler (from s15, synced) ──
