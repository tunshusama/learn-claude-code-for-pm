# s09: Context Compact — Context Will Fill Up, Have a Way to Make Room
...
1. `Read the file README.md, then read code.py, then read s02_agent_loop/README.md` (read multiple files consecutively, observe L2 compressing old results)
2. `Read every file in s09_context_compact/` (read a large amount of content at once, observe L3 persisting to disk)
