#!/usr/bin/env python3
"""
s17: Team Protocols — request-response protocol + request_id + dispatch + state machine.

Run:  python s17_team_protocols/code.py
...
# ── Prompt Assembly (from s11, synced) ──
...
# ── Background Tasks (from s14, synced) ──
...
# ── Unified Lead Inbox Consumer (s17 fix) ──
...
# ── Teammate Thread (s17: idle loop + dispatch) ──
