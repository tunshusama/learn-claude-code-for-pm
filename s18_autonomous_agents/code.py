#!/usr/bin/env python3
"""
s18: Autonomous Agents — idle poll + auto-claim + WORK/IDLE lifecycle.

Run:  python s18_autonomous_agents/code.py
...
# ── Teammate Thread (from s16 + s17 + s18) ──
        ...
        sub_tools = [
            ...
            {"name": "submit_plan",
             ...
             "input_schema": {"type": "object",
                              ...
                              "required": ["plan"]}},
            # s18 new: teammates can list, claim, and complete tasks
            {"name": "list_tasks",
