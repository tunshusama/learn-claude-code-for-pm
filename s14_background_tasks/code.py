#!/usr/bin/env python3
"""
s14: Background Tasks — thread-based async execution + notification injection.

Run:  python s14_background_tasks/code.py
