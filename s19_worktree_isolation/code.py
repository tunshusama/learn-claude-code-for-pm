#!/usr/bin/env python3
"""
s19: Worktree Isolation — git worktree + task-directory binding + event log.

Run:  python s19_worktree_isolation/code.py
...
# ── Task System (from s13 + s19 worktree field) ──
...
class Task:
    ...
    owner: str | None
    blockedBy: list[str]
    worktree: str | None = None      # s19: bound worktree name
...
# ── Autonomous Agent (from s18, + worktree cwd) ──
...
# ── Teammate Thread (from s16 + s17 + s18 + s19) ──
