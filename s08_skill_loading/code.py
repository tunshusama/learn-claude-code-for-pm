#!/usr/bin/env python3
"""
s08: Skill Loading — two-level on-demand knowledge injection.
...
Run: python s08_skill_loading/code.py
...
# s08: Skill catalog scan (used by build_system below)
...
# s08: SYSTEM includes skill catalog (cheap — just names + descriptions)
...
# s08: subagent gets its own system prompt — no skill loading, no task
SUB_SYSTEM = (
    f"You are a coding agent at {WORKDIR}. "
...
# ═══════════════════════════════════════════════════════════
#  FROM s03-s07 (unchanged): Tool Implementations
# ═══════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════
#  NEW in s08: load_skill — runtime full content loading
# ═══════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════
#  Tool Registry — all tools from s03-s08
# ═══════════════════════════════════════════════════════════
...
TOOLS = [
    ...
    # s08: skill tool (catalog is already in SYSTEM prompt, this loads full content)
...
# ═══════════════════════════════════════════════════════════
#  FROM s05 (unchanged): Hook System
# ═══════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════
#  agent_loop — same as s06-s07 + nag reminder
# ═══════════════════════════════════════════════════════════
