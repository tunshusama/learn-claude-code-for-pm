# s06: TodoWrite — An Agent Without a Plan Drifts Off Course
...
python s06_todo_write/code.py
```

Try these prompts:

1. `Refactor s06_todo_write/example/hello.py: add type hints, docstrings, and a main guard` (should list 3 steps first, then execute)
