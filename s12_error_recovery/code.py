#!/usr/bin/env python3
"""
s12: Error Recovery — three recovery paths + exponential backoff.

Run:  python s12_error_recovery/code.py
...
def reactive_compact(messages: list) -> list:
    ...
    retention since s09/s10 already cover LLM-based compact."""
