#!/usr/bin/env python3
"""
s20: MCP Tools — MCPClient + tool discovery + assemble_tool_pool.

Run:  python s20_mcp_plugin/code.py
...
Changes from s19:
  ...
  - Teammate tools: complete_task, worktree cwd (from s18/s19 fixes)
...
# ── Agent Loop (s20: dynamic tool pool, no prompt cache) ──
